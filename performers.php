...
<head>
  ...
  <title>Top & Weak Performers - Bet On Bat</title>
...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="nav-links">
      ...
      <li><a href="performers.php" class="nav-item active">Top/Weak</a></li>
  ...
  <main>
    <h1>Top & Weak Performers</h1>

    <?php if (!$approved): ?>
      <p style="color:#f85149; text-align:center; font-weight:bold;">
        Pending approval. Performers data not visible yet.
      </p>
    <?php else: ?>
      <div id="performers-list">
        <p>Loading top & weak performers...</p>
      </div>
    <?php endif; ?>
  </main>
